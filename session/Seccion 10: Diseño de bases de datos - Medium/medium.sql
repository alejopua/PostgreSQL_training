...
CREATE TABLE "user_list" (
  "user_list" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_id" integer,
  "title" varchar(100)
);
...
CREATE INDEX ON "user_list" ("user_id", "title");
...
ALTER TABLE "user_list_entry" ADD FOREIGN KEY ("user_list_id") REFERENCES "user_list" ("user_list");
