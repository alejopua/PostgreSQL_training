...
WHERE
    country LIKE '%Iceland'
    AND (last_connection LIKE '28%' or last_connection LIKE '112%' or last_connection LIKE '188%')
...
WHERE
	country LIKE '%Iceland'
	AND(last_connection LIKE '28%'
		OR last_connection LIKE '112%'
...
-- Ordenar los resultados por País asc, Primer nombre asc, apellido asc
-- Tip: Investigar IN
